...
public class BeesConstants {
    ...
    public static final String PROTOCOL_MOTAN = "bees";
    public static final String PROXY_JDK = "jdk";
    public static final String PROXY_JAVASSIST = "javassist";
    public static final String FRAMEWORK_NAME = "bees";
    ...
    public static final String HEARTBEAT_INTERFACE_NAME = "cn.huwhy.bees.rpc.heartbeat";
    ...
    public static final String ZOOKEEPER_REGISTRY_NAMESPACE = "/bees";
