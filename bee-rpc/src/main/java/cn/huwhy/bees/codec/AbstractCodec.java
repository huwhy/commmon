...
public abstract class AbstractCodec implements Codec {
    ...
    public ObjectOutput createOutput(OutputStream outputStream) {
        try {
            ...
            throw new BeesFrameworkException(this.getClass().getSimpleName() + " createOutput error", e,
    ...
    public ObjectInput createInput(InputStream in) {
        try {
            ...
            throw new BeesFrameworkException(this.getClass().getSimpleName() + " createInput error", e,
