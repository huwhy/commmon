...
public class URL {
    ...
    public URL(String host, int port, String path) {
        this(host, port, path, new HashMap<String, String>());
    }
    ...
    public static URL valueOf(String url) {
        if (StringUtils.isBlank(url)) {
            throw new BeesServiceException("url is null");
        }
        String host = null;
        int port = 0;
        String path = null;
    ...
    public URL createCopy() {
        ...
        return new URL(host, port, path, params);
    }
    ...
    public String getMethodParameter(String methodName, String paramDesc, String name) {
        String value = getParameter(BeesConstants.METHOD_CONFIG_PREFIX + methodName + "(" + paramDesc + ")." + name);
    ...
    public String getUri() {
        return host + ":" + port +
                BeesConstants.PATH_SEPARATOR + path;
    }
    ...
    public boolean canServe(URL refUrl) {
        ...
        if (!StringUtils.equals(this.getParameter(URLParamType.nodeType.getName()), BeesConstants.NODE_TYPE_SERVICE)) {
            return false;
        }
