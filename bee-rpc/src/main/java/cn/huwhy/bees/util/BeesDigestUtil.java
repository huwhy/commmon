...
public class BeesDigestUtil {

    private static Logger log = LoggerFactory.getLogger(BeesDigestUtil.class);
    ...
    public static long getCrc32(String str) {
        try {
            return getCrc32(str.getBytes(BeesConstants.DEFAULT_CHARACTER));
